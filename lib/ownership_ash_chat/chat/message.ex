defmodule OwnershipAshChat.Chat.Message do
  use Ash.Resource,
    otp_app: :ownership_ash_chat,
    domain: OwnershipAshChat.Chat,
    extensions: [AshOban],
  ...
  oban do
    triggers do
      trigger :respond do
        actor_persister OwnershipAshChat.AiAgentActorPersister
        action :respond
        queue :chat_responses
        lock_for_update? false
        scheduler_cron false
        worker_module_name OwnershipAshChat.Chat.Message.Workers.Respond
        scheduler_module_name OwnershipAshChat.Chat.Message.Schedulers.Respond
  ...
  actions do
    ...
    create :create do
      ...
      change OwnershipAshChat.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change OwnershipAshChat.Chat.Message.Changes.Respond
    end
  ...
  pub_sub do
    module OwnershipAshChatWeb.Endpoint
    prefix "chat"
  ...
  attributes do
    ...
    attribute :source, OwnershipAshChat.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, OwnershipAshChat.Chat.Conversation do
      public? true
      allow_nil? false
    end
