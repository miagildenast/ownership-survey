defmodule OwnershipAshChat.MixProject do
  use Mix.Project
  ...
  def application do
    [
      mod: {OwnershipAshChat.Application, []},
  ...
  defp deps do
    [
      ...
      {:dns_cluster, "~> 0.2.0"},
      {:bandit, "~> 1.5"},
      {:ex_check_ng, "1.0.0-rc.0", only: [:dev, :test], runtime: false}
    ]
  end
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind ownership_ash_chat", "esbuild ownership_ash_chat"],
      "assets.deploy": [
        "tailwind ownership_ash_chat --minify",
