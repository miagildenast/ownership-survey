...
config :ownership_ash_chat, OwnershipAshChatWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: OwnershipAshChatWeb.ErrorHTML, json: OwnershipAshChatWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: OwnershipAshChat.PubSub,
  live_view: [signing_salt: "S21x1zb8"]
...
config :ownership_ash_chat, OwnershipAshChat.Mailer, adapter: Swoosh.Adapters.Local
